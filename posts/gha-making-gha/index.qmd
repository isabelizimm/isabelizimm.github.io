...
The GitHub Action that sets off this package creation is below, or you can see the [action in the repo, for context](https://github.com/isabelizimm/cookiecutter-custompy/blob/main/.github/workflows/gen_cookie.yml). *Note: there are difference between the code below and the code in the repo, these changes were made for clarity and should not impact performance.*
