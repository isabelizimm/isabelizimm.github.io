...
[View the repository](https://github.com/isabelizimm/talk-pydata-global-2022/tree/main) || 
[Watch the recording](https://www.youtube.com/watch?v=we2hoIyLGXI)

```{=html}
<iframe width="780" height="500" src="https://www.isabelizimm.me/talk-pydata-global-2022/#/title-slide" title="Practical MLOps for better models"></iframe>
```
